        ...
        <div class="qfb-tabs-panel">
            ...
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Sets the height of the field, enter a number to that number of options at one time. Enter %sauto%s to set the height to show all options.', 'quform'), '<code>', '</code>'); ?></div></div>
