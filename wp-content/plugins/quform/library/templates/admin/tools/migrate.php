<?php if (!defined('ABSPATH')) exit; ?><div class="qfb qfb-cf qfb-page-tools-migrate">
    ...
    <div class="qfb-tools-migrate qfb-cf">
        ...
        <div class="qfb-settings">
            ...
            <div class="qfb-settings-heading"><i class="fa fa-suitcase"></i> <?php esc_html_e('Migrate from Quform 1.x', 'quform'); ?></div>
            ...
            <?php if (count($oldForms)) : ?>
                ...
                <div class="qfb-setting">
                    <div id="qfb-migrate-start" class="qfb-button-green"><i class="fa fa-suitcase"></i> <?php esc_html_e('Start migration', 'quform'); ?></div>
                </div>
